export { NgrxAutoEntityModule, NgRxAutoEntityRootModuleWithEffects, NgRxAutoEntityRootModuleNoEntityEffects, NgRxAutoEntityRootModuleNoEffects, NgRxAutoEntityFeatureModule, NgRxAutoEntityModuleConfig, } from './lib/module';
export { CustomStoreFactory, CustomStoreFeature, getNgRxAutoEntityMetaReducer, NGRX_AUTO_ENTITY_CONFIG, NgRxAutoEntityConfig, NgRxAutoEntityFeatures, provideAutoEntityState, provideAutoEntityStore, provideEntityService, withCustomStore, } from './lib/provider';
